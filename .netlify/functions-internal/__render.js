...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-e76deb78.js",
      css: [assets + "/_app/assets/start-61d1577b.css", assets + "/_app/assets/vendor-b92e0941.css"],
      js: [assets + "/_app/start-e76deb78.js", assets + "/_app/chunks/vendor-224dc68c.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      type: "page",
      pattern: /^\/authors\/([^/]+?)\/?$/,
      params: (m) => ({ authorId: d(m[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/authors/[authorId].svelte"],
      b: ["src/routes/__error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/authors/[authorId].svelte": () => Promise.resolve().then(function() {
    return _authorId_;
  }),
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-1a7c1915.js", "css": ["assets/pages/__layout.svelte-ce7a50df.css", "assets/vendor-b92e0941.css"], "js": ["pages/__layout.svelte-1a7c1915.js", "chunks/vendor-224dc68c.js"], "styles": [] }, "src/routes/__error.svelte": { "entry": "pages/__error.svelte-f4525832.js", "css": ["assets/vendor-b92e0941.css"], "js": ["pages/__error.svelte-f4525832.js", "chunks/vendor-224dc68c.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-5c2fd16a.js", "css": ["assets/pages/index.svelte-fbfb4348.css", "assets/vendor-b92e0941.css"], "js": ["pages/index.svelte-5c2fd16a.js", "chunks/vendor-224dc68c.js"], "styles": [] }, "src/routes/authors/[authorId].svelte": { "entry": "pages/authors/[authorId].svelte-809c3d19.js", "css": ["assets/pages/authors/[authorId].svelte-cf119813.css", "assets/vendor-b92e0941.css"], "js": ["pages/authors/[authorId].svelte-809c3d19.js", "chunks/vendor-224dc68c.js"], "styles": [] }, "src/routes/blog/[id].svelte": { "entry": "pages/blog/[id].svelte-2a8a924b.js", "css": ["assets/vendor-b92e0941.css"], "js": ["pages/blog/[id].svelte-2a8a924b.js", "chunks/vendor-224dc68c.js"], "styles": [] } };
...
var css$3 = {
  code: ".container.svelte-1p9pnzt{max-width:600px;margin:50px auto}ul.svelte-1p9pnzt{display:flex;list-style:none;padding:0}",
  map: null
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$3);
  return `<div class="${"container svelte-1p9pnzt"}"><nav><ul class="${"svelte-1p9pnzt"}"><li><a href="${"/"}">Home</a></li></ul></nav>
...
var css$1 = {
  code: ".posts.svelte-1qbuftp{display:grid;grid-template-columns:1fr 1fr;grid-gap:20px;margin:30px 0}.post.svelte-1qbuftp{border:1px solid #ddd;padding:10px;box-shadow:0 0 20px #eee}h2.svelte-1qbuftp{margin:0}.link.svelte-1qbuftp{text-align:right}@media all and (max-width: 600px){.posts.svelte-1qbuftp{display:grid;grid-template-columns:1fr;grid-gap:20px;margin:30px 0}}",
  map: null
};
...
<input type="${"text"}" place="${"search"}"${add_attribute("value", searchTerm, 0)}>

<div class="${"posts svelte-1qbuftp"}">${paginatedItems.length ? each(paginatedItems, (post) => `<div class="${"post svelte-1qbuftp"}"><h2 class="${"svelte-1qbuftp"}">${escape(post.title.substring(0, 20))}</h2>
            <p>${escape(post.body.substring(0, 80))}</p>
            <p class="${"link svelte-1qbuftp"}"><a sveltekit:prefetch${add_attribute("href", `/blog/${post.id}`, 0)}>Read More</a></p>
        </div>`) : `<p>No found</p>`}</div>

${searchedPost.length ? `${validate_component(LightPaginationNav, "LightPaginationNav").$$render($$result, {
...
var css = {
  code: "li.svelte-v0v4r{margin-bottom:10px;;}",
  map: null
};
var load$1 = async ({ page, fetch: fetch2 }) => {
  const authorId = page.params.authorId;
  const res = await fetch2(`https://jsonplaceholder.typicode.com/users/${authorId}?_embed=posts`);
  const user = await res.json();
  const posts = user.posts;
  return { props: { user, posts } };
};
var U5BauthorIdu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { user } = $$props;
  let { posts } = $$props;
  ...
  if ($$props.posts === void 0 && $$bindings.posts && posts !== void 0)
    $$bindings.posts(posts);
  $$result.css.add(css);
  return `<h1>${escape(user.name)}</h1>
<p>${escape(user.company.catchPhrase)}</p>
<p>${escape(user.email)}</p>

<h2>Posts by ${escape(user.name)}</h2>
<ul>${each(posts, (post) => `<li class="${"svelte-v0v4r"}"><a sveltekit:prefetch${add_attribute("href", `/blog/${post.id}`, 0)}>${escape(post.title)}</a>
    </li>`)}
</ul>`;
});
var _authorId_ = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
...
var load = async ({ page, fetch: fetch2 }) => {
  ...
  const res = await fetch2(`https://jsonplaceholder.typicode.com/posts/${postId}?_expand=user`);
...
<p>- Writer by <a sveltekit:prefetch${add_attribute("href", `/authors/${user.id}`, 0)}>${escape(user.name)}</a></p>`;
});
